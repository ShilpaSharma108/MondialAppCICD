...
//    }
    ...
    public void testUploadInvalidCSV() {
        ...
        System.out.println("[TEST 5] Uploaded file: invalid_customers.csv");
    ...
    /**
     * Test 6: Delete all uploaded customer records and verify deletion
     */
    @Test(priority = 6, dependsOnMethods = {"testUploadInvalidCSV"}, description = "Delete uploaded customer records")
    public void testDeleteUploadedRecords() {
        System.out.println("\n[TEST 6] Deleting uploaded customer records...");
        ...
        System.out.println("[TEST 6] All customer records deleted successfully");
    }
}
