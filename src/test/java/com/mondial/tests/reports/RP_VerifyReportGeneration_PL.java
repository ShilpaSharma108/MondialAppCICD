...
/**
 * Verify Report Generation - Profit and Loss Test Class
 * Verifies that a Profit + Loss report can be generated successfully via Report Writer
 */
public class RP_VerifyReportGeneration_PL extends BaseTest {
    ...
    public void reportGenerationSetup() {
        System.out.println("=== Starting Report Generation (P&L) Test Setup ===");
        ...
        System.out.println("=== Report Generation (P&L Annual Comparision) Test Setup Complete ===\n");
    }

    @Test(priority = 1, description = "Verify Report Writer - Profit and Loss Annual Comparision Report Generation")
    public void testReportGeneration_PL() {
        System.out.println("\n[TEST 1] Generating Profit + Loss report...");
        ...
        Assert.assertTrue(headerContent.contains("Profit"),
                "Report header should contain 'Profit' for report type: " + reportType);
        ...
        System.out.println("[TEST 1] Profit + Loss report generated and verified successfully");
